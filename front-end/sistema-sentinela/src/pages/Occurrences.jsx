...
const Occurrences = () => {
  ...
  const currentItems = ocorrencias.slice(startIndex, startIndex + itemsPerPage);
    ...
    <div>
      ...
      >
        <thead>
          <tr>
            ...
            <th style={{ color: "#6B7280", textAlign: "center" }}>Ações</th>
          </tr>
        </thead>
      ...
      >
        ...
        <Modal.Body>
          ...
          <strong>{selectedOccurrence?.numero_ocorrencia}</strong>?
        </Modal.Body>
        <Modal.Footer>
          ...
          <Button
            variant="danger"
            onClick={async () => {
              await fetch(`/api/ocorrencias/${selectedOccurrence.guid}/`, {
                method: "DELETE",
              });
